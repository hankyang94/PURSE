...
for objidx = 1:n_objs
    ...
    for idx = 1:n_samples
        ...
        [R_max,~,info] = compute_max_rotation_distance(R_avg,A_c,B_c,KAPPA);
        ...
        [~,t_max,info] = compute_max_translation_distance(t_avg,A_c,B_c,KAPPA);
...
matname = sprintf("pose_bound_%s_%.2f_%d.mat",score_type,epsilon,KAPPA);
if do_frcnn
    matname = sprintf("pose_bound_%s_%.2f_%d_frcnn.mat",score_type,epsilon,KAPPA);
end
